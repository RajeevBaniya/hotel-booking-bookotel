...
import exclusiveOfferGif from "./Dark Green and White Minimalist Geometric Shape House For Sale Video.gif";
...
export const exclusiveOffers = [
  {
    ...
    description: "Discover our premium properties with stunning amenities and luxury accommodations",
    priceOff: 15,
    expiryDate: "Dec 31",
    image: exclusiveOfferGif,
  },
];
...
export const facilityIcons = {
  ...
  "Mountains View": assets.mountainIcon,
...
export const roomsDummyData = [
  {
    ...
    roomType: "Double Bed",
    pricePerNight: 399,
    amenities: ["Room Service", "Mountains View", "Pool Access"],
  ...
  },
  {
    ...
    pricePerNight: 299,
    amenities: ["Room Service", "Mountains View", "Pool Access"],
    images: [roomImg2, roomImg3, roomImg4, roomImg5, roomImg1],
    isAvailable: true,
  ...
  },
  {
    ...
    images: [roomImg3, roomImg4, roomImg5, roomImg1, roomImg2],
    isAvailable: true,
  ...
  },
  {
    ...
    images: [roomImg4, roomImg5, roomImg1, roomImg2, roomImg3],
    isAvailable: true,
  ...
  },
  {
    ...
    pricePerNight: 169,
    amenities: ["Free Wifi", "Room Service", "Pool Access"],
    images: [roomImg5, roomImg4, roomImg1, roomImg2, roomImg3],
    isAvailable: true,
    createdAt: "2025-04-10T06:23:20.252Z",
    updatedAt: "2025-04-10T06:23:20.252Z",
    __v: 0,
